      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">CineView</h3>
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/80">Subscribe to our newsletter for the latest updates.</p>
            <div className="flex">
              <input
                type="email"
        ...
        <div className="mt-12 pt-8 border-t border-white/20 text-center text-white/80">
          <p>© {currentYear} CineView. All rights reserved.</p>
